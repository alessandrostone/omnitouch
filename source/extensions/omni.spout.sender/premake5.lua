...
project_ext_plugin(ext, "omni.spout.sender.plugin")
    local plugin_name = "omni.spout.sender"
    add_files("source", "plugins/"..plugin_name)
    add_files("source", "plugins/"..plugin_name.."/SPOUTSDK")
    includedirs { "plugins/"..plugin_name }
    includedirs { "plugins/"..plugin_name.."/SPOUTSDK" }
